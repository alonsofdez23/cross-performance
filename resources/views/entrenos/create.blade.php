            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('entrenos.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="message" name="entreno" rows="12" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-gray-500 focus:border-gray-500"></textarea>
                    </div>
